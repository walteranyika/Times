...
import timesu.sacco.app.adapters.CustomAbsentAdapter;
import timesu.sacco.app.models.Absent;
                ...
                if (responseString.contains("No Data Found")) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            Log.d(TAG, "onSuccess: Processing");

                        }
                        mCustomAdapter.notifyDataSetChanged();
                        Log.d(TAG, "onSuccess: Refreshing");
            ...
            spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    if (i!=0) {
                        ...
                        Log.d(TAG, "onItemSelected: FILTER WORKING");
                        mCustomAdapter.getFilter().filter("");
                    }
                }
