                ...
                if (constraint==null || constraint.length()==0){
                   ...
                   results.count=arrayList.size();
                    ...
                    for (Item u:arrayList) {
                        if(u.getBranch().toLowerCase().contains(search) || u.getDepartment().toLowerCase().contains(search))//|| u.getCourse().toLowerCase().contains(search) || u.getCampus().toLowerCase().contains(search)){
